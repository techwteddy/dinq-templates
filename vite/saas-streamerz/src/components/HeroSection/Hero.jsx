    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-4 flex flex-col items-center text-center">
                <motion.div variants={fadeInUp} className="mb-8 border border-neutral-800 px-3 py-2 rounded-full text-xs">
                ...
                <motion.div variants={fadeIn} className="py-10">
                    ...
                    <motion.div variants={fadeInUp} className="flex flex-wrap justify-center gap-8">
                        {BRAND_LOGOS.map((logo, index) => (
                            <img key={index} className="h-8" src={logo.src} alt={logo.alt} />
                        ))}
                    </motion.div>
                </motion.div>
