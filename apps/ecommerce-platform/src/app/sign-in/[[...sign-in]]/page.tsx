...
export default function SignInPage() {
    return (
        <main className="min-h-screen bg-paper relative flex flex-col items-center justify-center p-6 overflow-hidden">
            ...
            <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-acid/20 rounded-full blur-[120px] pointer-events-none"></div>
            <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-ink/5 rounded-full blur-[120px] pointer-events-none"></div>
            ...
            <div className="relative z-10 w-full max-w-md">
                <div className="mb-10 text-center space-y-4">
                    ...
                    <div>
                        <h1 className="font-display text-5xl tracking-tighter uppercase italic leading-none text-ink">
                            CITIZEN <span className="text-outline" style={{ WebkitTextStroke: '2px #0A2A1F' }}>ID.</span>
                        </h1>
                        <p className="font-bold opacity-30 uppercase tracking-[0.3em] text-[10px] mt-2">Secure biometric verification required</p>
                    </div>
                </div>
                ...
                <p className="mt-8 text-center text-[10px] font-bold uppercase tracking-widest opacity-20 italic">
                    All access attempts are logged ✦ HealMitra Intelligence Unit
                </p>
            </div>
        </main>
    );
